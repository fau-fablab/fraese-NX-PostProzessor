...
#=============================================================
  ...
  global mom_motion_event
   ...
   RAPID_SET
   set rapid_spindle_blk {G_motion X Y Z S}
   set rapid_spindle_x_blk {G_motion X S}
   set rapid_spindle_y_blk {G_motion Y S}
   set rapid_spindle_z_blk {G_motion Z S}
   set rapid_traverse_blk {G_motion X Y Z S}
   set rapid_traverse_xy_blk {G_motion X Y S}
   set rapid_traverse_yz_blk {G_motion Y Z S}
   set rapid_traverse_xz_blk {G_motion X Z S}
